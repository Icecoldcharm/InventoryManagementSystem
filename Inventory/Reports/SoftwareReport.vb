...
Public Class SoftwareReport
    ...
    Private Sub Detail_BeforePrint(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles Detail.BeforePrint
        curItem = CType(GetCurrentRow(), Software)
        ...
        If curItem.NumberOfLicenses Is Nothing Then
            lblLicenseCount1.Text = Nothing
            lblLicenseCount2.Text = Nothing
        Else
            lblLicenseCount1.Text = "License Count:"
        End If
        ...
        If curItem.Cost Is Nothing Or curItem.NumberOfLicenses Is Nothing Then
            lblTotal1.Text = Nothing
            lblTotal2.Text = Nothing
        Else
            lblTotal1.Text = "Total:"
            lblTotal2.Text = String.Format("{0:C}", (curItem.Cost * curItem.NumberOfLicenses))
        End If
